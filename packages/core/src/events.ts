...
import type { Clarification } from './contracts/clarify.js';
...
export type ConductorEvent =
  ...
  | { type: 'phase'; round: number; phase: 'setup' | 'clarify' | 'implement' | 'verify' | 'review' | 'confirm' | 'decide'; detail?: string }
  ...
  | { type: 'clarified'; clarifications: Clarification[] }
